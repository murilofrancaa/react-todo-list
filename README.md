...
- Persistência de tarefas com **usehooks-ts (localStorage)**  
- Componentização e uso de **hooks** para gerenciar estado  
...
- 🔍 Filtrar tarefas: todas, ativas ou concluídas  
...
```bash
git clone https://github.com/seuusuario/to-do-list-react.git
```
